...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Elenco Magazzino</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item">Elenco Magazzino</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table" id="prodottiMagazzino">
                                <thead>
                                    <tr>
                                    </tr>
                                </thead>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form id="editForm">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="stock_quantity">Qty Magazzino:</label>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="$('#prodottiMagazzino_filter input').focus();">Chiudi</button>
    ...
    <script src="elencoMagazzino.js"></script>
