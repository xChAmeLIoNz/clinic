...
<div style="display: inline-block; margin-right: 50px">
    <form action="" method="" id="salvaresult">
        ...
        -->
        <input type="number" placeholder="Togli Magazzino" id="qty_add" style="max-width:400px" /><br>
...
function numprodotti($conn)
{
    ...
    if ($conn->connect_error) {
        ...
        $sql0 = "SELECT count(sku) as sku from export_mag;";
...
<script>
    ...
    function refreshpage() {
        window.location.href = 'scanMag.php';
        document.getElementById("sku").focus();
