...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <form method="post" action="sync.php">
      <input type="submit" name="sync_clienti" value="Sincronizza" />
    </form>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Elenco Clienti</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Elenco Clienti</h5>
              <p></p>
              ...
              <table class="table datatable" id="prodotti">
                ...
                <tbody>
                  ...
                  $sql = "SELECT id, first_name, last_name, company, email, phone FROM clients";
