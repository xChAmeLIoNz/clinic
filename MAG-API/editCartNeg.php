...
if (isset($_POST['submit'], $_POST['sku'])) {
    ...
    if ($result = $conn->query("SELECT sku, qty_neg FROM export WHERE sku='$sku' AND id_user='$id_user';")) {
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Modifica Carrello Negozio</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item">Modifica Carrello Negozio</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="addCartNeg.php" method="POST">
                                <div class="col-12">
                                ...
                                <div class="text-center">
                                    ...
                                    <button class="btn btn-secondary"><a href="cartNeg.php" style="text-decoration: none; color: inherit;">Torna al Carrello</a></button>
                                </div>
                            </form><!-- Vertical Form -->
