...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Anomalie Giacenze</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item">Elenco Anomalie Giacenze</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Elenco prodotti con giacenza inferiore a 5
              </h5>
              <p></p>
              ...
              <table class="table datatable" id="prodotti">
                ...
                <tbody>
                  ...
                  $sql = "SELECT id, name, price, sku, stock_quantity FROM products WHERE stock_quantity <= 5";
